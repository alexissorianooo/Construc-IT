                ...
                <div class="modal-content" style="background-color: ivory;">
                    <section class="sec">
                        <div class="modal-header">
                            <h3 class="center CP">Create Project</h3><button type="button" class="close" data-dismiss="modal" aria-label="Close" style="max-width: 64.31px; max-height: 38px;"><span aria-hidden="true" style="max-width: 16.97px">×</span></button>
                        </div>
                    </section>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr class="text-center">
                                            <td class="lefttext" style="font-size: 19px;">Proposal<div class="text-center" style="padding-top: 3px"><label class="text-left" style="width: 100%;"><input class="form-control form-control-lg d-inline" type="text" id="input_design" style="border-style: none;color: rgb(0,0,0);max-width: 71%;height: 52px; margin: 0px" disabled="" placeholder="Design"><button class="btn btn-primary float-right activityButton" data-toggle="tooltip" data-bss-tooltip="" id="input_design" type="button" style="height: 53px;width: 67px;color: var(--white);background: transparent;border-width: 0px;margin: 1px;" onclick="toggleEnable(&#39;input_design&#39;)" title="Rename"><i class="fa fa-edit float-right align-items-center align-content-center" style="font-size: 38px;color: #000000;background: transparent;"></i></button></label></div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="lefttext">Contract Document Phase<div class="text-center" style="padding-top: 3px"><label class="text-left" style="width: 100%;"><input class="form-control d-inline" type="text" id="input_CPD1" style="border-style: none;color: rgb(0,0,0);max-width: 71%;height: 52px; margin: 0px" placeholder="Architectural Plans" disabled=""><button class="btn btn-primary float-right activityButton" data-toggle="tooltip" data-bss-tooltip="" type="button" style="height: 53px;width: 67px;color: var(--white);background: transparent;border-width: 0px;margin: 1px;" onclick="toggleEnable(&#39;input_CPD1&#39;)" title="Rename"><i class="fa fa-edit float-right align-items-center align-content-center" style="font-size: 38px;color: #000000;"></i></button></label></div>
                                                <div class="text-center"><label class="text-left" style="width: 100%;"><input class="form-control d-inline" type="text" id="input_CPD2" style="border-style: none;color: rgb(0,0,0);max-width: 71%;height: 52px; margin: 0px" placeholder="Structural Plans" disabled=""><button class="btn btn-primary float-right activityButton" data-toggle="tooltip" data-bss-tooltip="" type="button" style="height: 53px;width: 67px;color: var(--white);background: transparent;border-width: 0px;margin: 1px;" onclick="toggleEnable(&#39;input_CPD2&#39;)" title="Rename"><i class="fa fa-edit float-right align-items-center align-content-center" style="font-size: 38px;color: #000000;"></i></button></label></div>
                                                <div class="text-center"><label class="text-left" style="width: 100%;max-height: 53px;"><input class="form-control d-inline" type="text" id="input_CPD3" style="border-style: none;color: rgb(0,0,0);max-width: 71%;height: 52px; margin: 0px" placeholder="Mechanical, Electrical, Plumbing, and Fire" disabled=""><button class="btn btn-primary float-right activityButton" data-toggle="tooltip" data-bss-tooltip="" type="button" style="height: 53px;width: 67px;color: var(--white);background: transparent;border-width: 0px;margin: 1px;" onclick="toggleEnable(&#39;input_CPD3&#39;)" title="Rename"><i class="fa fa-edit float-right align-items-center align-content-center" style="font-size: 38px;color: #000000;"></i></button></label></div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="lefttext">Permit Processing<div class="text-center" style="padding-top: 3px"><label class="text-left" style="width: 100%;"><input class="form-control d-inline" type="text" id="input_PP1" style="border-style: none;color: rgb(0,0,0);max-width: 71%;height: 52px; margin: 0px;" placeholder="Barangay Permit" disabled=""><button class="btn btn-primary float-right activityButton" data-toggle="tooltip" data-bss-tooltip="" type="button" style="height: 53px;width: 67px;color: var(--white);background: transparent;border-width: 0px;margin: 1px;" onclick="toggleEnable(&#39;input_PP1&#39;)" title="Rename"><i class="fa fa-edit float-right align-items-center align-content-center" style="font-size: 38px;color: #000000;"></i></button></label></div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button class="btn btn-primary" type="button" style="max-width: 80.31px; max-height: 38px; color:white; background: #007bff; text-align:center">Create</button>
                    </div>
                </div>
            </div>
        </div>
