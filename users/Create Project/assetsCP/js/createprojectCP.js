...
function createForm(){
    ...
    input.setAttribute("style", "border-width: 2px; border-color: darkslategray; color: rgb(0,0,0);max-width: 75%;height: 52px; margin: 0px;");
    ...
    button1.setAttribute("style","height: 53px;background-color: transparent;color: transparent;border-width: 0px;margin: 1px;max-width: 67px;");
