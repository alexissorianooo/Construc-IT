...
<body>
    ...
    <!-- <a class="btn btn-primary btn-lg" role="button" data-toggle="modal" href="#createProjectModal">Create Project</a> -->
                ...
                <!-- <div class="col-sm-6 item" style="border-style: none;border-color: var(--bs-gray-dark);">
                    <div class="row">
                        ...
                        <div class="col text-end" style="background: #f9eeca;">
                            <h3 class="text-start name" style="color: var(--bs-dark);">Project Name&nbsp;</h3>
                            <p class="text-start"
                ...
                <div class="col-sm-6 item">
                    <div class="row">
                        ...
                        <div class="col text-end" style="background: #f9eeca;">
                            <h3 class="text-start name" style="color: var(--bs-dark);">Project Name&nbsp;</h3>
                            <p class="text-start"
                                style="color: rgb(0,0,0);font-family: Montserrat, sans-serif;font-style: normal;text-align: left;height: 35px;">
                                <strong>DEADLINE:</strong></p>
                            <p class="text-start"
                                style="color: rgb(0,0,0);font-family: Montserrat, sans-serif;font-style: normal;text-align: left;">
                                <strong>PROGRESS:</strong></p>
                            ...
                            <h1></h1>
                            <p class="description"></p><button class="btn btn-warning" data-bs-toggle="tooltip"
                                data-bss-tooltip="" data-bs-placement="bottom" data-bss-hover-animate="pulse"
                                type="button" title="Open Project"
                                style="font-size: 28px;background: rgb(248,197,44);margin: 13px;border-color: rgb(0, 0, 0);"><i
                                    class="fa fa-folder-open-o" title="Open Project"></i></button>
                        </div>
                    </div>
                ...
                <div class="col-sm-6 item" style="padding-bottom: 40px;">
                    <div class="row">
                        ...
                        <div class="col text-end" style="background: #f9eeca;">
                            <h3 class="text-start name" style="color: var(--bs-dark);">Project Name&nbsp;</h3>
                            <p class="text-start"
                                style="color: rgb(0,0,0);font-family: Montserrat, sans-serif;font-style: normal;text-align: left;height: 48px;">
    ...
    <!-- alexis -->
    <!-- <script src="../../users/Create Project/assets/js/jquery.min.js"></script>
    <script src="../../users/Create Project/assets/bootstrap/js/bootstrap.min.js"></script>
    <script src="../../users/Create Project/assets/js/bs-init.js"></script>
    <script src="../../users/Create Project/assets/js/createproject.js"></script> -->
