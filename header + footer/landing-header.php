...
<nav class="navbar navbar-dark navbar-expand-lg fixed-top bg-dark" id="mainNav">
    <div class="container">
        ...
        <!-- LOGO -->
        <a class="navbar-brand nav-link js-scroll-trigger" href="#home" style="background: url(&quot;assets/img/logo3-white.png&quot;) center / contain no-repeat, transparent;width: 162px;height: 55px;margin-top: 0px;color: rgb(254, 209, 54);"></a>>       </a>
