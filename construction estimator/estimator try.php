    ...
    <section style="margin-bottom: 20px;">
        <div class="container" style="border-style: solid;">
            <div class="row">
                ...
                <div class="col-md-6 offset-xl-0" style="background: var(--light);margin-bottom: 20px;"><h1 class="text-center" id="changetitle" value="none" style="padding-bottom: 20px;">Heading</h1><div class="text-left" id="brickDIV" style="display:none;">
